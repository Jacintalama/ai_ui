...
# Graph opens an in-page embed rather than navigating, so it must carry NO
# href — otherwise ctrl-click would bypass the embed.
ENTRIES = [
    ("data-aiui-build-website", "App Builder", "/Aiuibuilder"),
    ("data-aiui-video-gen", "Video Generation", "/video-generator"),
    ("data-aiui-cron-jobs", "Cron Jobs", "/cron-jobs"),
...
def test_a_non_admin_gets_all_four_without_a_workspace_link(page):

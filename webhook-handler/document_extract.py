...
NOTE: verbatim copy of mcp-servers/tasks/document_extract.py — the two services
share no library, so keep the copies in SYNC (patch BOTH if a guard changes).
Here it lets the Discord App Builder read PDF/Word/text attachments.
